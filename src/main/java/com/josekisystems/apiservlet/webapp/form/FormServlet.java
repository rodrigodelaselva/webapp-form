package com.josekisystems.apiservlet.webapp.form;
...
public class FormServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (email == null || !email.contains("@")) {
            errores.put("email","El email no es del formato requerido");
        }
        if (pais == null || pais.equals("") || pais.equals(" ")) {
            errores.put("pais","El pais es requerido");
        }
        if (lenguajes == null || lenguajes.length == 0) {
            errores.put("lenguajes","Tiene que seleccionar al menos un lenguaje de programación");
        }
        if (roles == null || roles.length == 0) {
            errores.put("roles","Tiene que seleccionar por lo menos un role");
        }
        if (idioma == null) {
            errores.put("idioma","Tiene que seleccionar un idioma");
        }
